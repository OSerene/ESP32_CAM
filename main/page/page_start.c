...
void start_logo()
{
	...
	lv_obj_t *label_speech = lv_label_create(lv_scr_act(), NULL);
	// lv_label_set_text(label_speech, "hello world!");
	lv_obj_clean(label_speech);
	ESP_LOGE("start_logo", "11111111!\n");
...
void page_init()
{
	...
	// printf("hello world 111111111111111111111");
}
